...
I develop a QA pipeline for multiple-choice (MCQ) and short-answer (SAQ) tasks
that require concise, format-constrained responses. The system adapts a base
LLM using parameter-efficient LoRA adapters \citep{Hu2021LoRA} and evaluates
both selection-based and generative answering. I also explore retrieval
augmentation for SAQ \citep{Lewis2020RAG}, aiming to improve factual recall
