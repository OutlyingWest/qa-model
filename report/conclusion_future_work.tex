...
component for SAQ. Across the iteration cycle, the largest SAQ gains come from
...
reaches 0.79 MCQ accuracy and 0.59 SAQ accuracy, while the current RAG
implementation does not yield a measurable SAQ improvement.
